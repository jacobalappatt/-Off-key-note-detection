...
% Added rms normalization that actually works
% Pitch shifting the second melody by half an octave
% UNADDRESSED - Generating a lot of extra files - consider deleting the first merged copy 
