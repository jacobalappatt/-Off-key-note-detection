function [ melody ] = make_newmel_sour_FromMalinda_changedmodes(n, sour, scale_degree_soured)
...
while final == 1
    ...
    %% Choose a starting note and corresponding key profile
        ...
        %variable was named major_key_profile. For testing, I just replaced the note profiles, but left variable names unchanged. 
        
        %minor key profile
        %major_key_profile = double([0.149, 0.179, 0, 0.144, 0, 0.201, 0.038, 0, 0.053,	0, 0.192, 0, 0.149, 0.179, 0, 0.144, 0, 0.201, 0.038, 0, 0.053,	0, 0.192, 0, 0.149, 0.179, 0, 0.144, 0, 0.201, 0.038, 0, 0.053,	0, 0.192, 0]);
  
        %bhairavi original
        %major_key_profile = double([0, 0.05, 0, 0.09, 0, 0.14, 0.05, 0, 0.05, 0, 0.26, 0.21, 0, 0.05, 0, 0.09, 0, 0.14, 0.05, 0, 0.05, 0, 0.26, 0.21, 0, 0.05, 0, 0.09, 0, 0.14, 0.05, 0, 0.05, 0, 0.26, 0.21]);
        
        %bhairavi intuit
        %major_key_profile = double([0, 0.07, 0, 0.183, 0, 0.184, 0.076, 0, 0.037, 0, 0.192, 0.115, 0, 0.07, 0, 0.183, 0, 0.184, 0.076, 0, 0.037, 0, 0.192, 0.115, 0, 0.07, 0, 0.183, 0, 0.184, 0.076, 0, 0.037, 0, 0.192, 0.115])
        
        %octatonic 
        major_key_profile =  double([0, .7, .5, 0, .7, .4, 0, .4, .4, 0, .8, .5, 0, .7, .5, 0, .7, .4, 0, .4, .4, 0, .8, .5, 0, .7, .5, 0, .7, .4, 0, .4, .4, 0, .8, .5]);
