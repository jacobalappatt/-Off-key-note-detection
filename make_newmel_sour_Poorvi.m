function [ melody ] = make_newmel_sour_Bhairavi(n, sour, scale_degree_soured, mode)
...
while final == 1
    ...
    elseif sour ==1 && scale_degree_soured==1 %Make a sour note
        if isempty(find(rem((melody1(n-3:n-1)-melody1(1)),12)==0))
            ...
            ind = indices(1);
            melody1(ind+(n-4)) = melody1(ind+(n-4))+2; %Changed from +1 to +2 because we already have 2b/1# in the mode. We don't have natural 2 in the original mode. 
            final = 0;
    ...
    elseif sour ==1 && scale_degree_soured==3
        ...
        if isempty(find(rem((melody1(n-3:n-1)-(melody1(1)+4)),12)==0))
            ...
            ind = indices(1);
            melody1(ind+(n-4)) = melody1(ind+(n-4))+1; %Changed from +2 to +1 because we already have 3b/2# in the mode. We don't have natural 3 in the original mode. 
            final = 0;
    ...
    elseif sour ==1 && scale_degree_soured==5
        ...
        if isempty(find(rem((melody1(n-3:n-1)-(melody1(1)+7)),12)==0))
            ...
            ind = indices(1);
            melody1(ind+(n-4)) = melody1(ind+(n-4))+2; %Changed from +1 to +2 because we already have 6b/5# in the mode. We don't have natural 6 in the original mode. 
            final = 0;
